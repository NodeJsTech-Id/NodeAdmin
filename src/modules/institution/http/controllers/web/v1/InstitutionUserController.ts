...
export default class InstitutionUserUserController {
    ...
    public async index(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views'+appConfig.be_view+'/institution_user/index'), {
            filter,
            datas,
            paginate_data,
            institution,
    ...
    public async create(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views'+appConfig.be_view+'/institution_user/create'), {
            users,
            institution,
            layout: './layouts/be/main'
        })
    ...
    public async edit(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views'+appConfig.be_view+'/institution_user/edit'), {
            data,
            institution,
            layout: './layouts/be/main'
        })
