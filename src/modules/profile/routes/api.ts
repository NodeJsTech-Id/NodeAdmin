...
profileRoute.put('api.v1.profile.update', '/api/v1/profile/update', AccessMiddleware, ensureAuthenticatedApi, upload.any(), UserUpdateValidator, profileController.update.bind(profileController))
