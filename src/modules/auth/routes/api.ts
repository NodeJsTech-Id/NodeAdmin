...
router.post('api.v1.auth.login', '/api/v1/auth/login', authController.login.bind(authController))
router.get('api.v1.auth.logout', '/api/v1/auth/logout', ensureAuthenticatedApi, authController.logout.bind(authController))
router.post('api.v1.auth.register', '/api/v1/auth/register', UserCreateValidator, authController.register.bind(authController))
router.post('api.v1.auth.reset.request', '/api/v1/auth/reset/request', authController.request.bind(authController))
router.post('api.v1.auth.reset.process', '/api/v1/auth/reset/process', ResetPasswordProcessValidator, authController.process.bind(authController))
