...
export default class MenteeClassController {
    ...
    public async index(req: Request, res: Response) {
        ...
        filter.q_user = user.id
        const {datas,paginate_data} = await this.classService.index(filter)
        res.render(path.resolve(Module.path, 'views'+appConfig.be_view+'/mentee/class/index'), {
            datas,
            filter,
            paginate_data,
    ...
    public async index_subject(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views'+appConfig.be_view+'/mentee/subject/index'), {
            classData,
            datas,
            filter,
            paginate_data,
    ...
    public async show_content(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views'+appConfig.be_view+'/mentee/subject/show'), {
            data,
    ...
    public async index_user(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views'+appConfig.be_view+'/mentee/user/index'), {
            classData,
            datas,
            filter,
            paginate_data,
    ...
    public async index_mentor(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views'+appConfig.be_view+'/mentee/mentor/index'), {
            classData,
            datas,
            filter,
            paginate_data,
