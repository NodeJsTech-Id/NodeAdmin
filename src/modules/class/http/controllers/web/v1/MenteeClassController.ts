...
export default class MenteeClassController {
    ...
    public async index(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views/mentee/class/index'), {
            datas,
            filter,
            paginate_data,
            layout: './layouts/main'
    ...
    public async index_subject(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views/mentee/subject/index'), {
            classData,
            datas,
            filter,
            paginate_data,
    ...
    public async index_user(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views/mentee/user/index'), {
            classData,
            datas,
            filter,
            paginate_data,
    ...
    public async index_mentor(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views/mentee/mentor/index'), {
            classData,
            datas,
            filter,
            paginate_data,
