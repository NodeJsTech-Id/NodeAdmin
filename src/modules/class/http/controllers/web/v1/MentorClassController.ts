...
export default class MentorClassController {
    ...
    public async index(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views/mentorView/class/index'), {
            datas,
            filter,
            paginate_data,
            layout: './layouts/main'
    ...
    public async index_subject(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views/mentorView/subject/index'), {
            classData,
            datas,
            filter,
            paginate_data,
    ...
    public async index_user(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views/mentorView/user/index'), {
            classData,
            datas,
            filter,
            paginate_data,
    ...
    public async index_mentor(req: Request, res: Response) {
        ...
        res.render(path.resolve(Module.path, 'views/mentorView/mentor/index'), {
            classData,
            datas,
            filter,
            paginate_data,
