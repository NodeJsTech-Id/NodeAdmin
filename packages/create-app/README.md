...
Prinsip yang diterapkan (detail di [`docs/ARCHITECTURE.md`](https://github.com/FlazHost-Com/NodeAdmin/blob/main/docs/ARCHITECTURE.md)):
...
Suite lengkap — detail di [`docs/TESTING.md`](https://github.com/FlazHost-Com/NodeAdmin/blob/main/docs/TESTING.md).
...
Endpoint REST `/api/v1/*` (auth via JWT Bearer). Daftar lengkap + contoh request/response di [`docs/API.md`](https://github.com/FlazHost-Com/NodeAdmin/blob/main/docs/API.md).
