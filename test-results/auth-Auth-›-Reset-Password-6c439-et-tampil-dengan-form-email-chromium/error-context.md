...
- Name: auth.spec.ts >> Auth › Reset Password >> halaman request reset tampil dengan form email
...
Locator: locator('h1')
Expected substring: "Forgot Password"
Timeout: 10000ms
...
```yaml
- text: Reset Password
- paragraph: Masukkan email Anda. Kami akan kirimkan OTP 6 digit.
- text: Email
