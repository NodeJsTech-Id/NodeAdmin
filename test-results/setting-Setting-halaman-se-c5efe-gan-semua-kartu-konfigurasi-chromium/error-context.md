...
- Name: setting.spec.ts >> Setting >> halaman setting tampil dengan semua kartu konfigurasi
- Location: tests/e2e/setting.spec.ts:6:7
...
Locator: locator('h2:has-text("Frontend Template")')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('h2:has-text("Frontend Template")')
...
- banner:
  ...
  - link "Welcome,  ":
    - /url: "#"
- main:
  - heading "Setting Management" [level=1]
  - text: 
  - heading "Admin Theme" [level=2]
  - paragraph: Pilih template — seluruh tampilan admin akan berubah warnanya setelah disimpan.
  - radio "blue blue"
  - text: blue blue
  - radio "black black"
  - text: black black
  ...
  - radio "yellow yellow"
  - text: yellow yellow
  - heading "Setting Form" [level=2]
  - text: App Name [name]
  - textbox "App Name [name]": CppAdmin
  - text: Copyright Text [copyright]
  - textbox "Copyright Text [copyright]"
  - text: Company Logo [logo]
  - button "Company Logo [logo]"
  - text: Login Image [login_image]
  - button "Login Image [login_image]"
  - button " Save"
```
