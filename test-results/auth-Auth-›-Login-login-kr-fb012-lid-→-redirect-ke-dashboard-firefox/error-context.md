...
- Name: auth.spec.ts >> Auth › Login >> login kredensial valid → redirect ke dashboard
...
Expected pattern: /Node Admin/i
Received string:  "CppAdmin"
Timeout: 10000ms

Call log:
  - Expect "toHaveTitle" with timeout 10000ms
    22 × unexpected value "CppAdmin"
