...
- Name: auth.spec.ts >> Auth › Register >> link "Already have an account?" mengarah ke halaman login
...
Call log:
  - waiting for locator('a:has-text("Already have an account")')
