...
- Name: auth.spec.ts >> Auth › Reset Password >> request reset email tidak terdaftar → redirect login + alert error
...
Received string:  "http://localhost:3000/admin/v1/auth/reset/proc"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    24 × unexpected value "http://localhost:3000/admin/v1/auth/reset/proc"

```

```yaml
- text: Reset Password Jika email terdaftar, OTP telah dikirim. Email
- textbox "email@example.com"
- text: OTP (6 digit)
- textbox "123456"
- text: Password Baru
- textbox "min. 8 karakter"
